...
This repository is a workspace scaffold for reverse engineering and decompilation tooling. It is not a source of Xbox 360 system binaries, game binaries, decrypted XEX files, IDA databases, or proprietary SDK material.

Keep these out of Git history:

- original `.xex`, `.xbe`, or extracted PE images
- decrypted/repacked console binaries
- IDA/Ghidra databases containing proprietary binary contents
